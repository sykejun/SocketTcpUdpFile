package com.example.kejun.myapplication.adapter;
...
import com.example.kejun.myapplication.activity.FileSelectorActivity;
import com.example.kejun.myapplication.bean.FileBean;
...
public class FileSelectorAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.ivEditor = convertView.findViewById(R.id.iv_editor);
            holder.ivFile = convertView.findViewById(R.id.iv_file_logo);
